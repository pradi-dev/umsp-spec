...
- [Vision & Goals](./architecture/vision.md)
- [System Overview](./architecture/overview.md)
- [Addressing](./architecture/addressing.md)
...
- [Conventions](./protocol/conventions.md)
- [Server Discovery](./protocol/server-discovery.md)
- [Identity & Key Management](./protocol/identity.md)
- [Authentication](./protocol/authentication.md)
- [Transport Layer](./protocol/transport.md)
- [Event Format](./protocol/event-format.md)
- [Messaging Events](./protocol/messaging.md)
- [Channel Federation](./protocol/channel-federation.md)
- [Media Repository](./protocol/media-repository.md)
- [Voice & Video Signaling](./protocol/voice-video.md)
